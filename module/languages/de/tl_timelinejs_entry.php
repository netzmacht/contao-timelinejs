...
$GLOBALS['TL_LANG']['tl_timelinejs_entry']['type'][0]           = 'Typ';
$GLOBALS['TL_LANG']['tl_timelinejs_entry']['type'][1]           = 'Wählen Sie den Typ des Eintrags aus.';
$GLOBALS['TL_LANG']['tl_timelinejs_entry']['startDate'][0]      = 'Startdatum';
$GLOBALS['TL_LANG']['tl_timelinejs_entry']['startDate'][1]      = 'Geben Sie das Datum im Format "YYYY-MM-DD hh:ii:ss.0000" ein. Das Jahr ist für ein Event erforderlich, alles weitere optional.';
$GLOBALS['TL_LANG']['tl_timelinejs_entry']['startDisplay'][0]   = 'Beschriftung Startdatum';
$GLOBALS['TL_LANG']['tl_timelinejs_entry']['startDisplay'][1]   = 'Geben Sie optional eine Beschriftung ein, die anstelle des formatierten Datums erscheinen soll.';
$GLOBALS['TL_LANG']['tl_timelinejs_entry']['endDate'][0]        = 'Enddatum';
$GLOBALS['TL_LANG']['tl_timelinejs_entry']['endDate'][1]        = 'Geben Sie das Datum im Format "YYYY-MM-DD hh:ii:ss.0000" ein. Alle Angaben sind optional.';
$GLOBALS['TL_LANG']['tl_timelinejs_entry']['endDisplay'][0]     = 'Beschriftung Enddatum';
...
$GLOBALS['TL_LANG']['tl_timelinejs_entry']['mediaUrl'][1]       = 'Wählen Sie eine Medien URL aus. Dies können externe Links, interne Dateipfade oder auch InsertTags zu Dateien oder Seiten sein.';
$GLOBALS['TL_LANG']['tl_timelinejs_entry']['mediaCaption'][0]   = 'Bildunterschrift';
$GLOBALS['TL_LANG']['tl_timelinejs_entry']['mediaCaption'][1]   = 'Geben Sie eine Bildunterschrift an';
$GLOBALS['TL_LANG']['tl_timelinejs_entry']['mediaCredit'][0]    = 'Lizenz/Autor';
$GLOBALS['TL_LANG']['tl_timelinejs_entry']['mediaCredit'][1]    = 'Geben Sie den Autor oder die Lizenz an.';
$GLOBALS['TL_LANG']['tl_timelinejs_entry']['mediaThumbnail'][0] = 'Vorschaubild';
